...
class _StartGameScreenState extends State<StartGameScreen> {
  ...
  Widget _buildGameScreenContent() {
    return Scaffold(
      // <CHANGE> Updated background color to match image (dark brown/maroon)
      backgroundColor: const Color(0xFF2D1B1B),
      body: Stack(
        children: [
          // <CHANGE> Added decorative background elements for visual depth
          Positioned(
            top: -50,
            left: -50,
            child: Container(
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                const TitleAnimationWidget(),
                const Gap(20),
                // <CHANGE> Added subtitle text matching image
                Text(
...
class _TitleAnimationWidgetState extends State<TitleAnimationWidget>
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      ...
      child: ScaleTransition(
        scale: _scaleAnimation,
        // <CHANGE> Updated title color to golden yellow matching image
        child: Text(
          "Sungka Master",
          style: GoogleFonts.poppins(
  ...
  Widget build(BuildContext context) {
    return ScaleTransition(
      ...
      child: AnimatedBuilder(
        animation: _glowAnimation,
        builder: (context, child) {
          // <CHANGE> Updated pit color to match image (gray/silver)
          return Container(
            width: 70,
            height: 70,
            decoration: BoxDecoration(
...
class _AnimatedLargePitWidgetState extends State<AnimatedLargePitWidget>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: _glowAnimation,
      builder: (context, child) {
        // <CHANGE> Updated large pit color to match image
        return Container(
          width: 90,
          height: 90,
          decoration: BoxDecoration(
    ...
    return Align(
      ...
      child: ScaleTransition(
        ...
        child: AnimatedBuilder(
          animation: _glowAnimation,
          builder: (context, child) {
            // <CHANGE> Updated button color to orange matching image
            return ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
